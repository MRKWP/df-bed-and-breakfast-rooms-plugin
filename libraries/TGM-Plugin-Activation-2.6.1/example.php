 ...
 * @subpackage Example
 * @version    2.6.1 for plugin Testimonials
...
add_action( 'tgmpa_register', 'df_wp_testimonials_register_required_plugins' );
 ...
 */
function df_wp_testimonials_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'df-wp-testimonials',                 // Unique ID for hashing notices for multiple instances of TGMPA.
